...
<div class="flex">
    ...
    <section class="login-form flex flex-col flex-1 items-center justify-center gap-9 p-36 lg:p-80">
        ...
        <form class="flex flex-col w-full items-end gap-4" action="">
            <input class="input input-block" type="email" placeholder="Email" />
            <input class="input input-block" type="password" placeholder="Password" />
